...
export default function Privacy() {
  return (
    <section sx={{ variant: "section.privacy" }}>
      <Container>
        <div class="page__content">
          <h1 id="privacy-policy-for-accountable">
            Privacy Policy for accountable
          </h1>
          <p>Last updated: February 28, 2021</p>
          <p>
          ...
          <ul>
            ...
            <li>
              ...
              “We”, “Us” or “Our” in this Agreement) refers to accountable.
            </li>
            <li>
            ...
            <li>
              <strong>Website</strong> refers to accountable, accessible from
              https://www.getaccountable.ca/
            </li>
            <li>
          ...
          <h3 id="information-from-third-party-social-media-services">
