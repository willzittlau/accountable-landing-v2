export default {
  ...
  colors: {
    ...
    background_secondary: '#EFEBE9', // secondary background color
    muted: '#B9BABC', // muted color
    border_color: '#B9BABC', // border color
    primary: '#A1887F', // primary button and link color
    secondary: '#A1887F', // secondary color - can be used for hover states
    background_brand: '#EFEBE9',
  ...
  fonts: {
    body: "'D-DIN', 'DM Sans', sans-serif",
    heading: "'Futura-Heavy', 'Bree Serif', serif",
    special: "'D-DIN-Bold', 'Roboto Slab', serif",
  },
  ...
  text: {
    ...
    heroPrimary: {
      color: 'white',
      fontSize: ['48px', '48px', '56px', '64px', '72px', '80px', '92px', '100px'],
      lineHeight: [1.3, 1.25],
      fontWeight: 'body',
      mb: [4, 5],
      px: [0, 3, 6, 4, 0],
